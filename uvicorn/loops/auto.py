...
def auto_loop_factory(use_subprocess: bool = False) -> Callable[[], asyncio.AbstractEventLoop]:
    try:
        if sys.platform == "win32":  # pragma: py-win32
            from uvicorn.loops.winloop import winloop_loop_factory as loop_factory  # pragma: py-not-win32
        else:  # pragma: py-win32
            from uvicorn.loops.uvloop import uvloop_loop_factory as loop_factory  # pragma: py-win32
